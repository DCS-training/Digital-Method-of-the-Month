...
# Getting Started with SQL and non-SQL Databases



## Today's schedule

- 14:00-15:05 Housekeeping

- 14:05-14:10  Introduction to method

- 14:10-14:25 Roundtable introductions and discussion

- 14:25 –14:50 Training Led Talk
...
MongoDB is an example of a Non-Sequel Database, one which has a UI designed around cloud access (The Compass), and various programming interfaces to explore and generate insights into data. Usefully, data can be accessed in different programming interfaces, including Python and R - where complex computational analyses can take place, and then can be reuploaded to suit the needs of the programmer.
